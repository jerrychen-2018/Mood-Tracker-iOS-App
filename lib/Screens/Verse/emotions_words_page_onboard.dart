import 'dart:convert';
import 'package:ebbnflow/Screens/Verse/verse_page_onboard.dart';
...
class EmotionWordsPageOnboard extends StatefulWidget {
  const EmotionWordsPageOnboard({Key? key}) : super(key: key);

  @override
  State<EmotionWordsPageOnboard> createState() =>
      _EmotionWordsPageOnboardState();
}

class _EmotionWordsPageOnboardState extends State<EmotionWordsPageOnboard> {
          ...
          builder: (context) => Scaffold(
            appBar: AppBar(
              leading: IconButton(
                  ...
                  onPressed: () => Navigator.of(rootContext).pushAndRemoveUntil(
                      MaterialPageRoute(
